...
python3 label_image_int8.py --model_file mobilenetv2_0.35_cifar10_int8.tflite --label_file labels_cifar_10.txt --image test_cat.jpg --input_mean 0 --input_std 255
