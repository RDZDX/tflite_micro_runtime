...
#model_path = 'okay_nabu.tflite' # - bad
#model_path = 'alexa.tflite'
#model_path = 'hey_mycroft_v0.1.tflite' # - uzsiveda !
#model_path = 'vad.tflite'
#model_path = 'micro_speech_quantized.tflite' #index i3
#model_path = 'keyword_spotting_on_off.tflite'
#model_path = 'audio.tflite'
#model_path = 'audio_preprocessor_int8.tflite' # - bad
#model_path = 'converted_speed_keras_model.tflite'
#model_path = 'mfcc_317885_100.tflite' # - bad
#model_path = 'mfcc_416159_100.tflite'
