...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '-i',
      '--image',
      default='test_cat.jpg',
      help='image to be classified')
  parser.add_argument(
      '-m',
      '--model_file',
      default='cifar_10_float32.tflite',
      help='.tflite model to be executed')
  parser.add_argument(
      '-l',
      '--label_file',
      default='labels_cifar_10.txt',
  ...
  img = Image.open(args.image).convert('RGB').resize((width, height), Image.Resampling.LANCZOS)
  # add N dim
