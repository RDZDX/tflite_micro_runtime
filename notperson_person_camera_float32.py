...
#
# $ python3 notperson_person_camera.py --model notperson_person2.tflite --label labels_notperson_person2.txt
...
@contextlib.contextmanager # for hidding pycamera2 log output
def ignore_stderr():
